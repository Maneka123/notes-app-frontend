  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400">
      ...
      >
        ...
        <button className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold p-3 rounded-lg hover:from-pink-500 hover:to-purple-500 transition-colors duration-300 mb-4 shadow-md">
          Login
        </button>
