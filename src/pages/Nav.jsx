...
const Nav = ({ setPage }) => {
  const navItems = [
    ...
    { name: "Add Collaborators", page: "add-collaborators", icon: "👥" },
  ...
  return (
    <aside className="bg-gray-900 text-white w-64 h-screen flex flex-col">
      {navItems.map((item) => (
        <div
          key={item.name}
          className="flex items-center justify-center gap-4 flex-1 cursor-pointer hover:bg-purple-700 transition-all duration-200"
